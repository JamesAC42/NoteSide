<?php include 'hidden/editcode.php'; ?><head>
	<meta charset="utf-8">
	<meta author="jamesac">
				...
				<form action="" method="post" id="submit-note">
					<div class="row">
						<div class="col">
							...
							<input name="note-title" value="<?php echo $ogtitle; ?>" id="title-input" type="text" required></input>
						</div>
						<div class="col">
							<label for="section-input">Chapter/ Section</label>
							<input name="section-name" value="<?php echo $ogsection; ?>" id="section-input" type="text" required>
						</div>
					</div>
					<div class="row">
						<div class="col">
								...
								<?php
									...
									if(mysql_num_rows($getclasses) == 0){
										...
										while ($class = mysql_fetch_assoc($getclasses)) {
											...
											if($classname == $ogclassname){
												echo '<option selected="selected" value="' . $classname . '">' . $classname . '</option>';
											}else{
					...
					<div class="row">
						<div class="col">
							<button type="submit" id="submit-button" class="btn" name="action" value="note-submit">Update</button>
						</div>
						<div class="col">
...
<div class="container">
	...
	<textarea name="note-content" id="text_area" form="submit-note" required><?php echo htmlspecialchars($filecontents); ?></textarea>
</div>
<script>countAll();</script>
